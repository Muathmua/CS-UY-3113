...
void Level_Win::initialise()
{
    GLuint map_texture_id = Utility::load_texture("assets/act_clear.png");
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL_WIN_DATA, map_texture_id, 8.0f, 1, 1);
    ...
    m_game_state.bgm = Mix_LoadMUS("assets/sonic-level-finish.wav");
...
void Level_Win::update(float delta_time)
{
...
void Level_Win::render(ShaderProgram* g_shader_program)
{
