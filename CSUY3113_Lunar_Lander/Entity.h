...
enum EntityType { PLATFORM, PLAYER, ENEMY, UI  };
...
public:
    ...
    //void const check_collision_win(Entity* other);
    ...
    bool      const get_collided_win() const { return m_collided_win; }
    bool const get_is_win() const { return is_win_tile; }
    ...
    void const set_acceleration_y(float new_y_accel) { m_acceleration.y = new_y_accel; }
    void const set_acceleration_x(float new_x_accel) { m_acceleration.x = new_x_accel; }
    ...
    void const set_collided_win() { m_collided_win = true; }
    void const set_win_tile() { is_win_tile = true; }
